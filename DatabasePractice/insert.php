...
<title></title>
                ...
                <div class="divB">
                    <div class="divD">
                      ...
                      //  $db = mysqli_select_db("test", $connection);
                        ...
                        $query = mysqli_query($connection,"insert employee set employee_name='$name', employee_email='$email', employee_contact='$mobile', 
   employee_address='$address'" );
                   ...
                   if (isset($_GET['submit'])) {
				   echo '<div class="form" id="form3"><br><br><br><br><br><br><Span>Data Inserted Successfuly......!!</span></div>';
				   }
                    ?>
                    <div class="clear"></div>
                </div>
